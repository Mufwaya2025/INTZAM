...
def bootstrap_website_content():
    ...
    page_defaults = [
        {'slug': 'home', 'navigation_label': 'Home', 'template': WebsitePageTemplate.LANDING, 'eyebrow': 'Website editor', 'hero_title': 'Launch richer public content around your lending platform.', 'hero_description': 'Use admin-managed sections, blocks, and images to keep the public website fresh without changing code.', 'hero_primary_cta_text': 'Apply Now', 'hero_primary_cta_url': '/client-pwa/', 'hero_secondary_cta_text': 'Open Calculator', 'hero_secondary_cta_url': '/calculator/', 'show_in_nav': False, 'nav_order': 0},
        {'slug': 'about', 'navigation_label': 'About', 'template': WebsitePageTemplate.STANDARD, 'eyebrow': 'About IntZam', 'hero_title': 'Built to make lending feel more human, clear, and dependable in Zambia.', 'hero_description': 'Present your mission, values, and operating approach with a polished public experience.', 'hero_primary_cta_text': 'Go to client portal', 'hero_primary_cta_url': '/client-pwa/', 'hero_secondary_cta_text': 'Try the calculator', 'hero_secondary_cta_url': '/calculator/', 'show_in_nav': True, 'nav_order': 4},
